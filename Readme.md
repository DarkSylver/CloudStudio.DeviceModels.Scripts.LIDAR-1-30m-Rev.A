...
# Parsing + Configuration Script – LIDAR-1-30m - Rev. A

This **Parsing + Configuration** script is designed for the **LIDAR-1-30m** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – LIDAR-1-30m Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **LIDAR-1-30m** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
